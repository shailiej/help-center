...
- The requested `docker_version` must be one of the versions Replicated supports. Currently supported versions are - 
  - Replicated Native - docker_version_minimum to docker_version_default
  - Replicated Swarm - swarm_docker_version_minimum to swarm_docker_version_default{{% /page_notes %}}
